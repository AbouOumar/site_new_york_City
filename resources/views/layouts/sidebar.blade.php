<aside class="bg-gradient-to-b from-gray-700 to-gray-900 text-white w-64 flex-shrink-0 min-h-screen hidden md:flex flex-col shadow-lg">
    <!-- Logo -->
    <div class="flex items-center gap-2 px-6 py-5 border-b border-white/10">
        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 11H9v-2h2v2zm0-4H9V5h2v4z"/>
        </svg>
        <span class="text-xl font-bold">Hotel Manager</span>
    </div>
